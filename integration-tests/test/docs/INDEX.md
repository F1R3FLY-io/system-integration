...
| 1 | [test_validator_lifecycle](test_validator_lifecycle.md) | Full PoS validator lifecycle (3 joiners): concurrent bond, rewards, concurrent bond+unbond, epoch-move shrink+grow, quarantine payout, re-bond — bg-on throughout, cross-node FS-identity (slashing out of scope) |
...
**Total: 24 tests across 10 files.**
