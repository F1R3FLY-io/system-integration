...
**Last updated:** 2026-05-14 (after PR #519 runs 25881518121 + 25882551410, PR #520 run 25891109017)
...
| **CI job examples (post-PR-#518)** | • **rust/staging run [25820782609](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25820782609) amd64-docker-4** ([job 75862590920](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25820782609/job/75862590920)) — gw1 [91%], inclusion-budget shape on the post-merge rust/staging run<br>• **rust/staging run [25829535904](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25829535904) attempt 3 arm64-docker-3** ([job 75904014983](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25829535904/job/75904014983)) — gw1 [91%], `Production readiness FAILED` recurrence on arm64 (companion to a same-job `test_merge_determinism_asymmetric_divergence` failure on pre-poll-fix code)<br>• **rust/staging run [25829535904](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25829535904) attempt 1 amd64-subprocess-5** ([job 75892097867](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25829535904/job/75892097867)) and **arm64-subprocess-2** ([job 75892097903](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25829535904/job/75892097903)) — severe variant: `LFB rate degraded: 1.9 blk/min is 11% of initial`, 13 consecutive stalled batches, 8/10 deploys not included. LFB advances #0→#19 in 81s then freezes for 524s. Distinct from the light "inclusion ≥10s on 1-2 bridge deploys" variant.<br>• **PR #519 run [25881518121](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25881518121) arm64-docker-5** ([job 76063958467](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25881518121/job/76063958467)) — `Deploy inclusion: 3/10 sampled deploys not included within 15s: #61 (bridge), #121 (bridge), #136 (bridge)`<br>• **PR #519 run [25882551410](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25882551410) attempt 1 amd64-subprocess-2** ([job 76069555959](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25882551410/attempts/1)) — combined: `LFB stalled: 5 consecutive batches` + `inclusion 3/10 ≥10s` + `finalization 1/10 ≥45s` (severe variant on amd64 this time)<br>• **PR #519 run [25882551410](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25882551410) attempt 3 arm64-subprocess-4** ([job 76081993123](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25882551410/job/76081993123)) — `inclusion 3/10 within 15s: #76 (bridge), #91 (bridge), #106 (bridge)`<br>• **PR #520 run [25891109017](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25891109017) amd64-docker-5** ([job 76096551695](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25891109017/job/76096551695), [artifact 7007389364](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25891109017/artifacts/7007389364)) — `inclusion 2/10 within 10s: #121 (bridge), #136 (bridge)`<br>• **PR #520 run [25891109017](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25891109017) arm64-docker-1** ([job 76096551699](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25891109017/job/76096551699), [artifact 7007412913](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25891109017/artifacts/7007412913)) — `inclusion 4/10 within 15s: #91, #106, #121, #136 (all bridge)`, arm64 severity |
...
| **CI job examples** | • PR #518 amd64-subprocess-2 on rerun ([job 75853479655](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25815988420/job/75853479655)) — failed at gw0 [60%]. Log shows the deploy's resolver returns `DEPLOY_STATE_FINALIZED` on all 5 nodes (5× `state: DEPLOY_STATE_FINALIZED` log lines) immediately before the balance-poll begins; the balance still doesn't reflect the transfer within 45s.<br>• **rust/staging run [25829535904](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25829535904) attempt 3 amd64-docker-1** ([job 75904014963](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25829535904/job/75904014963)) — same shape, recurring on amd64-docker. Confirms it's not subprocess-specific.<br>• **PR #519 run [25882551410](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25882551410) attempt 3 amd64-docker-5** ([job 76081992993](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25882551410/job/76081992993)) — **two #9 hits in the same job**: canonical `test_validator1_pay_validator2` TimeoutError after 45s, plus a NEW sub-shape from `test_transfers_interleaved_with_queries@shared` where the balance is off by exactly one transfer (`expected 50000000000426672, got 49999999999426672`). Same root cause (post-resolver-FINALIZED state-anchor lag) surfacing as a stale exploratory-deploy read instead of a polling timeout — the test happens to query at the precise moment the resolver claims FINALIZED but the readonly's state still reflects the pre-transfer balance. |
...
| **Status** | **Resolved 2026-05-16** ([system-integration commit pending]). Re-examination of the most recent reproduction ([PR #521 run 25977312979 amd64-subprocess-3 job 76360039982](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25977312979/job/76360039982)) showed the readonly node DID see the post-transfer state stably (block 115 onward returned the updated balance through 122). The failure was the test's strict `==` predicate rejecting a balance that overshot the expected value by a small proposer-reward credit V2 earned in blocks between the pre-transfer snapshot and the canonical transfer block — not the state-anchor lag this entry hypothesized. Test fixed in `test_wallets.py`: post-transfer balance read now pinned to `canonical_block_hash` (opportunistic, in case real lag manifests later) and predicate switched from `==` to `>=` (the actual bug fix). The earlier cataloged examples were likely the same pattern with the predicate noise blamed on a node-side lag that does not in fact reproduce when examined closely. If a true resolver-vs-state-anchor lag does surface in the future (balance stays at pre-transfer value for the entire poll window, not just overshooting by a small amount), file a fresh entry in [`active-flakes.md`](active-flakes.md). |

---

### 10. Boot reaches HTTP responsiveness but `/api/status` never reports `isReady=true` (300s timeout)

A subset of `boot did not reach Running state within 300s` failures have a *distinct* shape from the #3 family. Boot's HTTP `/api/status` endpoint is responsive (200 OK throughout the 300s window — payload size varies, indicating internal state IS changing), but the `isReady` field never flips to true. Framework's `wait_for_node_running` polls both the process and the HTTP status; timeout fires while boot is alive and serving HTTP. Sixty-plus dependent shared-shard tests then cascade-skip with the same setup error.

| | |
|---|---|
| **Test that surfaces it** | Whichever shared-shard test runs first on the worker — typically [`integration-tests/test/tests/shared/test_bridge_admin.py::test_bridge_api_exploratory`](../integration-tests/test/tests/shared/test_bridge_admin.py) — but the failure is in the `shared_shard` fixture itself, so any caller of `shared_shard` is symmetric. |
| **Symptom (exact)** | `TimeoutError: Node rnode.test.<id>.boot did not reach Running state within 300s. Last logs: ...` followed by the framework's tail of /api/status responses, all showing HTTP 200 with payload size oscillating between ~682 and ~919 bytes (so isReady=true is never set; framework is parsing the JSON correctly). |
| **CI job examples** | • **rust/staging run [25829535904](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25829535904) attempt 1 amd64-subprocess-1** ([job 75892097836](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25829535904/job/75892097836)) — `64 passed, 1 error in 1407.09s`<br>• **rust/staging run [25829535904](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25829535904) attempt 3 amd64-subprocess-4** ([job 75904015041](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25829535904/job/75904015041)) — `29 passed, 64 skipped, 1 error in 1351.08s` (same shape, different worker) |
| **Distinction from #3** | #3a/3b: node process exited before reaching Running. #3c: rnode bound port failed → process exit. This entry: **process is alive, HTTP server bound and serving, isReady stays false**. Different stage of startup is stuck. |
| **Hypothesis** | Boot's readiness signal is gated on something beyond the HTTP/transport bind (e.g., genesis-ceremony completion, approved-block confirmation, latest-messages-map initialization). Whatever predicate flips `isReady` is not completing within 300s under load. Not a port race — not a network race — boot is fundamentally inside a loop or wait that's not making progress. |
| **Why no rnode log yet** | The framework registered handles in `_active_handles` *after* `wait_for_node_running` succeeded. On startup failure, handles were leaked and never archived. **Fixed in system-integration `333c976`** (`wait_for_handles_or_archive` archives every spawned process's log before re-raising). Next reproduction will have boot's full rnode log in `log-archive/<session>/shard{N}/boot.log` for diagnosis. |
| **Related issue** | TBD — investigate boot readiness predicate (the gate that flips `isReady` from false to true) |
| **Status** | Open. 2 observations so far, both on amd64-subprocess. Need rnode boot log from next reproduction to identify the stuck startup phase. |

---

### 11. Joiner replay rejects block during epoch transition with `BondsCacheMismatch` → cascading `ConsumeFailedReplayDivergence`

A joiner replaying the chain during an epoch transition rejects a block as `InvalidBondsCache` because the bonds it computes from the PoS contract don't match the bond cache recorded in the block. The invalid block then poisons its successors: subsequent blocks fail to replay with `ConsumeFailed` errors (since the parent state never materialized), and the forbidden-pattern scanner catches the chain of `RecordingInvalidBlock` / `ConsumeFailedReplayDivergence` warnings.

| | |
|---|---|
| **Test that surfaced it** | [`integration-tests/test/tests/custom/test_consensus_safety.py::test_epoch_transition_under_heartbeat`](../integration-tests/test/tests/custom/test_consensus_safety.py) |
| **Symptom (exact, in order)** | 1. `[FORBIDDEN] [BondsCacheMismatch]` — `"Bonds in proof of stake contract do not match block's bond cache."` at `casper/src/rust/validate.rs:1236`<br>2. `[FORBIDDEN] [InvalidBondsCache]` — `"Recording invalid block 665ff69460... for InvalidBondsCache."`<br>3. `[FORBIDDEN] [RecordingInvalidBlock]` — `"Recording invalid block 44ff9d9f47... for NeglectedInvalidBlock."` (child of the rejected block)<br>4. `[FORBIDDEN] [ConsumeFailedReplayDivergence]` — `"Replay block 7cd4c6fd63... got error SystemRuntimeError(ConsumeFailed)"` (×3 retries, then `"giving up after 3 retries"`)<br>5. `[FORBIDDEN] [RecordingInvalidBlock]` — `"Recording invalid block 7cd4c6fd63... for InvalidTransaction."` |
| **CI job examples** | • **rust/staging run [25838379945](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25838379945) attempt 1 arm64-subprocess-5** ([job 75918968238](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25838379945/job/75918968238)) — joiner = `rnode.test.56da1071.joiner1`, first FORBIDDEN at 02:53:30 (about 60s into the test). Failed at gw1 [53%].<br>• **PR #520 run [25891109017](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25891109017) arm64-subprocess-1** ([job 76096551732](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25891109017/job/76096551732), [artifact 7007391213](https://github.com/F1R3FLY-io/f1r3node/actions/runs/25891109017/artifacts/7007391213)) — boot LFB stuck at #3 vs target #12 + 118 forbidden entries on joiner1 (`BondsCacheMismatch` at validate.rs:1236, then cascading `InvalidBondsCache` recordings). Second observation confirms arm64-subprocess pattern. |
| **When in the test** | `test_epoch_transition_under_heartbeat` rotates the validator set across an epoch boundary while heartbeat keeps blocks flowing. The joiner is attached to the shard and replays the recently-produced chain. At the epoch boundary, blocks recorded with one bonds-cache snapshot need to validate against PoS-contract state derived from a slightly different snapshot. |
| **Why it's likely a real node bug, not a test issue** | `BondsCacheMismatch` is a node-side `Invalid` verdict from `validate.rs` — the joiner explicitly says the block lies about its bonds. If the validators all agreed on this block (which they did — the block is in the chain), but the joiner can't reconstruct the same bonds when it replays, that's a determinism gap somewhere in: (a) the block's recorded bond cache, (b) the PoS contract evaluation order, or (c) the epoch-boundary state snapshot the cache was taken at. |
| **Why this surfaces on arm64-subprocess specifically** | Slower per-thread on arm64-Altra widens the timing window for the epoch-transition race. The bonds-cache snapshot may be taken at one wall-clock moment on the producer, and the joiner's replay reads the PoS contract at a sufficiently-different state to disagree. Hasn't reproduced on amd64-E6 (single observation so far). |
| **Downstream cascade in the same joiner** | Once a block is marked `InvalidBondsCache`, its successor (`44ff9d9f47...`) is `NeglectedInvalidBlock`. The next sibling (`7cd4c6fd63...`) fails to replay with `ConsumeFailed` because the parent state never materialized — joiner retries 3× then records the block as `InvalidTransaction`. The forbidden-pattern scanner catches all of these in teardown; the test is failed via the scanner's mechanism. |
| **Related issue** | TBD — file new f1r3node issue. Reference `casper/src/rust/validate.rs:1236` (the BondsCacheMismatch verdict site) and the epoch-transition + heartbeat scenario. |
| **Status** | Open. 1 observation. Node-side fix required (deterministic bonds-cache + PoS-state alignment across epoch boundaries). |
...
- [x] ~~Investigate #9 (resolver-FINALIZED vs exploratory-state-visibility window in `test_wallets` balance poll).~~ **Resolved 2026-05-16**: re-examination showed the readonly DID see post-transfer state stably; the failure was a strict `==` predicate rejecting a small proposer-reward overshoot. Test fixed to `>=` with canonical-block pin; node-side investigation closed.
- [ ] Investigate #10 (boot HTTP-responsive but isReady=false for 300s). Next reproduction will have full boot rnode log in `log-archive/<session>/shard{N}/boot.log` thanks to `333c976` (spawn-time archival). Look for the readiness predicate that's not flipping.
- [ ] File f1r3node issue for #11 (joiner `BondsCacheMismatch` during epoch transition; `casper/src/rust/validate.rs:1236`). Reference `test_epoch_transition_under_heartbeat` and watch for recurrence on shape-upgraded arm64 + amd64.
- [ ] Revisit "marginal" callers of `assert_all_nodes_agree_on_block` / `assert_bonds_map_consistent_across_nodes` IF any start flaking. After `8ec8971` made the retrieval-poll opt-in (`timeout=0` default), six callers across [`test_contract_lifecycle.py`](../integration-tests/test/tests/shared/test_contract_lifecycle.py) (L158, L282, L439, L582, L605) and [`test_bonding_validators.py`](../integration-tests/test/tests/shared/test_bonding_validators.py) (L302) remain one-shot. Each has a `wait_for_finalized(single_node)` barrier upstream — covers the queried node, not the full set. None observed flaking in the tracker so far; pre-`4c64141` they ran one-shot and stayed stable. If a flake surfaces, opt them into polling by passing `timeout=timeouts.finalization`.
